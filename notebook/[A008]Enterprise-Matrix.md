...
攻击者尝试收集信息，以便为未来的行动计划提供支持。

侦察是指攻击者主动或被动地收集用于支持目标定位的信息。这些信息可能包括受害者组织、基础设施或员工/人员的详细情况。攻击者可以利用收集到的信息来协助其生命周期的其他阶段，例如使用收集到的信息来规划和执行初始访问、确定和优先处理被攻陷后的目标，或者推动和领导进一步的侦察工作。

**Techniques**:

|Tech|Sub-Tech|中文|External ID|
|---|---|---|---|
|[Gather Victim Identity Information](##[T1589]:Gather Victim Identity Information)||**搜集受害者身份信息**|T1589|
||[Credentials](###[T1589.001]:Credentials)|凭证|T1589.001|
||[Email Addresses](###[T1589.002]:Email Addresses)|电子邮箱地址|T1589.002|
||[Employee Names](###[T1589.003]:Employee Names)|雇员姓名|T1589.003|
|[Gather Victim Network Information](##[T1590]:Gather Victim Network Information)||**搜集受害者网络信息**|T1590|
||[Domain Properties](###[T1590.001]:Domain Properties)|域属性|T1590.001|
||[DNS](###[T1590.002]:DNS)|DNS|T1590.002|
||[Network Trust Dependencies](###[T1590.003]:Network Trust Dependencies)|网络信任依赖关系|T1590.003|
||[Network Topology](###[T1590.004]:Network Topology)|网络拓扑|T1590.004|
||[IP Addresses](###[T1590.005]:IP Addresses)|IP地址|T1590.005|
||[Network Security Appliances](###[T1590.006]:Network Security Appliances)|网络安全应用|T1590.006|
|[Gather Victim Org Information](##[T1591]:Gather Victim Org Information)||**搜集受害者组织信息**|T1591|
||[Determine Physical Locations](###[T1591.001]:Determine Physical Locations)|确定物理位置|T1591.001|
||[Business Relationships](###[T1591.002]:Business Relationships)|商业关系|T1591.002|
||[Identify Business Tempo](###[T1591.003]:Identify Business Tempo)|确定业务节奏|T1591.003|
||[Identify Roles](###[T1591.004]:Identify Roles)|确定角色|T1591.004|
|[Gather Victim Host Information](##[T1592]:Gather Victim Host Information)||**搜集受害者主机信息**|T1592|
||[Hardware](###[T1592.001]:Hardware)|硬件|T1592.001|
||[Software](###[T1592.002]:Software)|软件|T1592.002|
||[Firmware](###[T1592.003]:Firmware)|固件|T1592.003|
||[Client Configurations](###[T1592.004]:Client Configurations)|客户配置|T1592.004|
|[Search Open Websites/Domains](##[T1593]:Search Open Websites/Domains)||**从开放网站/域中搜索**|T1593|
||[Social Media](###[T1593.001]:Social Media)|社交媒体|T1593.001|
||[Search Engines](###[T1593.002]:Search Engines)|搜索引擎|T1593.002|
||[Code Repositories](###[T1593.003]:Code Repositories)|代码仓库|T1593.003|
|[Search Victim-Owned Websites](##[T1594]:Search Victim-Owned Websites)||**从受害者自己的网站中搜索**|T1594|
|[Active Scanning](##[T1595]:Active Scanning)||主动扫描|T1595|
||[Scanning IP Blocks](###[T1595.001]:Scanning IP Blocks)|扫描IP块|T1595.001|
||[Vulnerability Scanning](###[T1595.002]:Vulnerability Scanning)|漏洞扫描|T1595.002|
||[Wordlist Scanning](###[T1595.003]:Wordlist Scanning)|字典扫描|T1595.003|
|[Search Open Technical Databases](##[T1596]:Search Open Technical Databases)||**从开放技术数据库中搜索**|T1596|
||[DNS/Passive DNS](###[T1596.001]:DNS/Passive DNS)|DNS/Passive DNS|T1596.001|
||[WHOIS](###[T1596.002]:WHOIS)|WHOIS|T1596.002|
||[Digital Certificates](###[T1596.003]:Digital Certificates)|数字证书|T1596.003|
||[CDNs](###[T1596.004]:CDNs)|CDNs|T1596.004|
||[Scan Databases](###[T1596.005]:Scan Databases)|扫描数据库|T1596.005|
|[Search Closed Sources](##[T1597]:Search Closed Sources)||**从封闭数据中搜索**|T1597|
||[Threat Intel Vendors](###[T1597.001]:Threat Intel Vendors)|威胁情报供应商（threat intelligence vendors）|T1597.001|
||[Purchase Technical Data](###[T1597.002]:Purchase Technical Data)|购买技术数据|T1597.002|
|[Phishing for Information](##[T1598]:Phishing for Information)||**网络钓鱼获取信息**|T1598|
||[Spearphishing Service](###[T1598.001]:Spearphishing Service)|钓鱼服务|T1598.001|
||[Spearphishing Attachment](###[T1598.002]:Spearphishing Attachment)|钓鱼附件|T1598.002|
||[Spearphishing Link](###[T1598.003]:Spearphishing Link)|钓鱼链接|T1598.003|
...
敌手可能会收集用于定向攻击的凭证。敌手收集到的帐户凭证可能是直接与目标受害者组织相关的，或者试图利用用户在个人和商业帐户之间使用相同密码的倾向。

敌手可能以各种方式从潜在受害者那里收集凭证，例如通过[钓鱼信息搜集](https://attack.mitre.org/techniques/T1598)直接诱导获取。敌手还可能篡改网站，然后添加旨在从访问者那里收集网站身份验证cookie的恶意内容。(引用：ATT ScanBox)凭证信息还可能通过泄露给在线或其他可访问数据集(例如[搜索引擎](https://attack.mitre.org/techniques/T1593/002)、漏洞数据库、代码库等)而暴露给敌手。(引用：德勤注册)(引用：优步注册)(引用：Detectify Slack令牌)(引用：福布斯GitHub凭据)(引用：GitHub truffleHog)(引用：GitHub Gitrob)(引用：CNET泄漏)敌手还可能从暗网或其他黑市购买凭证。最后，如果基于非通道通信的多因素身份验证(MFA)正在使用，敌手可能会破坏服务提供商以获取MFA代码和一次性密码(OTP)。(引用：Okta Scatter Swine 2022)

收集这些信息可能会揭示其他形式的侦察机会(例如[搜索开放网站/域名](https://attack.mitre.org/techniques/T1593)或[钓鱼信息搜集](https://attack.mitre.org/techniques/T1598)),建立操作资源(例如[破坏帐户](https://attack.mitre.org/techniques/T1586)),以及/或初始访问(例如[外部远程服务](https://attack.mitre.org/techniques/T1133)或[有效帐户](https://attack.mitre.org/techniques/T1078))。
...
攻击者可能会收集关于受害者网络信任依赖关系的信息，这些信息可以在定向攻击时使用。关于网络信任的信息可能包括各种细节，包括连接(并可能提高)网络访问的第二或第三方组织/域名(例如：托管服务提供商，承包商等)。

攻击者可以通过多种方式收集此类信息，例如通过[钓鱼获取信息](https://attack.mitre.org/techniques/T1598)直接诱导获取。关于网络信任的信息也可通过在线或其他可访问的数据集(例如：[搜索开放技术数据库](https://attack.mitre.org/techniques/T1596))暴露给攻击者。(引用：渗透AD森林)收集此类信息可能会揭示其他形式的侦察机会(例如：[主动扫描](https://attack.mitre.org/techniques/T1595)或[搜索开放网站/域名](https://attack.mitre.org/techniques/T1593)),建立运营资源(例如：[获取基础设施](https://attack.mitre.org/techniques/T1583)或[破坏基础设施](https://attack.mitre.org/techniques/T1584)),以及/或初始访问(例如：[受信任的关系](https://attack.mitre.org/techniques/T1199))。
